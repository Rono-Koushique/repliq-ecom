...
export default function SearchField({ addClass = "" }: Props) {
    return (
        <div className={`${addClass} flex-1`}>
            <div className="w-full flex items-center border-2 border-slate-200 rounded-full  focus-within:border-slate-500">
                <input
